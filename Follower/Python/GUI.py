...
def setup():
    ...
    drone_1_IP_entry.grid(row=1, column=0, padx=5, sticky='e')
    drone_2_IP_entry = Entry(right_frame, width=12, font=('Arial 16'))
    drone_2_IP_entry.grid(row=1, column=0, padx=5, sticky='e')
