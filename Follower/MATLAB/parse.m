...
logimport = mavlinktlog('2_2_1_complete.tlog',dialect); 
...
plot3(0, 0, 0.00, '-o', 'Color', 'Red');
text(-0.8, 0, -0.2, '(0.00, 0.00, 0.00)', 'FontName', 'times', 'FontSize', 12);

plot3(-2.00, -2.00, 1, '-o', 'Color', 'Red');
text(-3, 0, 0.6, '(-2.00, -2.00, 1.00)', 'FontName', 'times', 'FontSize', 12);

plot3(-2.00, 2.00, 1, '-o', 'Color', 'Red');
text(-2.8, 1.8, 1.2, '(-2.00, 2.00, 1.00)', 'FontName', 'times', 'FontSize', 12);

plot3(2.00, 2.00, 1, '-o', 'Color', 'Red');
text(1.4, 2.03, 1.2, '(2.00, 2.00, 1.00)', 'FontName', 'times', 'FontSize', 12);

plot3(2.00, -2.00, 1, '-o', 'Color', 'Red');
text(1.1, -2.01, .8, '(2.00, -2.00, 1.00)', 'FontName', 'times', 'FontSize', 12);

plot3(-2.00, -2.00, 0, '-o', 'Color', 'Red');
text(-3, 0, 0.6, '(-2.00, -2.00, 0.00)', 'FontName', 'times', 'FontSize', 12);

plot3(-2.00, 2.00, 0, '-o', 'Color', 'Red');
text(-2.8, 1.8, 1.2, '(-2.00, 2.00, 0.00)', 'FontName', 'times', 'FontSize', 12);

plot3(2.00, 2.00, 0, '-o', 'Color', 'Red');
text(1.4, 2.03, 1.2, '(2.00, 2.00, 0.00)', 'FontName', 'times', 'FontSize', 12);

plot3(2.00, -2.00, 0, '-o', 'Color', 'Red');
text(1.1, -2.01, .8, '(2.00, -2.00, 0.00)', 'FontName', 'times', 'FontSize', 12);
